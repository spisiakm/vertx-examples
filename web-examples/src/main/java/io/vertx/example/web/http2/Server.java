  ...
  public void start() throws Exception {
    ...
    vertx.createHttpServer(
            new HttpServerOptions()
                    .setSsl(true)
                    .setUseAlpn(true)
                    .setPemKeyCertOptions(new PemKeyCertOptions().setKeyPath("classpath:tls/server-key.pem").setCertPath("classpath:tls/server-cert.pem"))).requestHandler(router::accept)
            .listen(8443);
  }
}
